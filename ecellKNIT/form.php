...
$cw= $_POST['cw'];
$ca= $_POST['ca'];
$add_resi= $_POST['add_resi'];
$add_local= $_POST['add_local'];


if(mysql_query("INSERT INTO alumni (rollno,fname,lname,email,phone,batch,branch,selfemp,cw,ca,add_resi,add_local) VALUES('$rollno','$fname','$lname','$email','$mobile','$batch','$branch','$selfemp','$cw','$ca','$add_resi','$add_local')")){
